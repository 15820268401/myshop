   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="header">
      ...
      <div class="header-top">
        ...
        <div class="sitename">
          <h1><a href="" title="Go to Start page">SEVERUS&bull;SHOP<span style="font-weight:normal;font-size:50%;">&nbsp;¹º¿ÍÖ®¼Ò</span></a></h1>
          <h2>********************************************</h2>
        </div>
        ...
        <div class="nav1">
          <ul>
            ...
            <li><a href="buy.do"><bean:message key="myshopping.cart"/></a></li>	
    ...
    <div class="main">
      ...
      <div class="main-subcontent">
        ...
        <div class="subcontent-unit-border">
          ...
          <center>
          	<font size="4">
	          	<b><bean:message key="dear.user"/></b><br><br>
	          	<b><c:out value="${userForm.username}"/></b><br><br>
	          	<b><bean:message key="welcome.to.here"/></b>
          	</font>
          </center>     
        </div>
