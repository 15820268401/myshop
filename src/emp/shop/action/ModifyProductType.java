...
public class ModifyProductType extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		productType = productTypeDao.queryProductTypeById(ptf.getProduct_type_id());
		
		request.getSession().setAttribute("back_productType", productType);
